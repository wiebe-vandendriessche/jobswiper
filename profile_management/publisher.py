...
from domain_model import JobSeeker
from interfaces import IChangedJobSeekerPublisher

logger = logging.getLogger(__name__)
logging.basicConfig(level=logging.INFO, format="%(message)s")


class ChangedJobSeekerPublisher(IChangedJobSeekerPublisher):
    ...
    async def __send_message(self, message: JobSeeker):
